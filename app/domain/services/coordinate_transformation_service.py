...
class CoordinateTransformationService:
    ...
    def apply_modification(
        original_coordinate: Coordinate, modification: CoordinateModification
    ) -> Coordinate:
    ...
    @staticmethod
    def calculate_delta(original: Coordinate, modified: Coordinate) -> Coordinate:
        """Calculate the delta between two coordinates."""
        return Coordinate(modified.x - original.x, modified.y - original.y)
